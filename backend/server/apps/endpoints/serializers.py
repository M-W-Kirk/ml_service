# These serializers will help with packing and unpacking database objects into JSON objects.
#---START----------------------------------------
...
class MLAlgorithmSerializer(serializers.ModelSerializer):
    ...
    def get_current_status(self, mlalgorithm):
        return MLAlgorithmStatus.objects.filter(parent_algorithm=mlalgorithm).latet('created_at').status
...
class MLRequestSerializer(serializers.ModelSerializer):
    class Meta:
        model = MLRequest
        read_only_fields = ("id", "input_data", "full_resonse", "response", "created_at", "parent_mlalgorithm")
